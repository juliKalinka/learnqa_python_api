...
class Logger:
    ...
    @classmethod
    def add_results(cls, expected_value, current_value,is_equal):
        #data_to_add = "\n-----\n"
        data_to_add = f"Expected value: {expected_value}\n"
        data_to_add += f"Сurrent value: {current_value}\n"
        data_to_add += f"is equal: {is_equal}\n"
       # data_to_add += "\n-----\n"
